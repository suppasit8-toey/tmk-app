...
import { Home, Users, Package, FileText, Settings, PenTool, LogOut, Share2, FolderKanban, Store, Megaphone, Truck, X } from 'lucide-react';
...
export default function Sidebar({ currentPath, isOpen, onClose }: { currentPath: string; isOpen?: boolean; onClose?: () => void; }) {
    return (
        <>
            {isOpen && (
